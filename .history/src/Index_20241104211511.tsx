      ...
      <div className="App h-screen">
        <nav className='flex  bg-blue-600'>
          <ul className='flex flex-nowrap justify-content'>
            <li className="content-center ml-6"><Link to="/">
            <FaHome 
             style={{ fontSize: '2rem' , color:"#303ebf"}}
            />
            </Link></li>
            <li className="content-center ml-8"><Link to="https://www.facebook.com/profile.php?id=100075747225558">
              <FaSquareFacebook
              size={30} 
              color="#303ebf"/>
              </Link>
            ...
            {/* 做預約功能連結 */}
            <li className=" content-center ml-8"><Link to="/">
            <Appointment/>
            </Link></li>
            {/* 預留會員註冊與登錄 */}
