...
interface ImageSliderProps{
  handleClickLineOfficial?: (event: React.MouseEvent<HTMLImageElement>) => void;
}
...
const ImageSlider: React.FC<ImageSliderProps> = ({handleClickLineOfficial) => {
  ...
  function handleClickLineOfficial (event: React.MouseEvent<HTMLImageElement>){
  ...
  return (
    <div className="w-screen h-fit relative">
      <div 
        ...
        >
        <img 
        className=' w-24 h-24 mt-60 -ms-96'
        src='https://qr-official.line.me/gs/M_870ixmou_GW.png' alt='Line 連結'
        onClick = {handleClickLineOfficial}
        />
      </div>
