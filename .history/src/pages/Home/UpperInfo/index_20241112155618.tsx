...
const UpperInfo = () => {
  return (
    ...
    <div className="flex flex-wrap bg-blue-600 font-black object-contain p-4">
      <div className="w-full xs:w-1/1 sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 p-4 text-center">
        瑞昱豐興業有限公司
      </div>
      <div className="w-full xs:w-1/1 sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 p-4 text-center">
      ...
      <div className="w-full xs:w-1/1 sm:w-1/1 md:w-1/3 lg:w-1/4 xl:w-1/5 p-4 text-center">
        <div className="flex items-center justify-center">
