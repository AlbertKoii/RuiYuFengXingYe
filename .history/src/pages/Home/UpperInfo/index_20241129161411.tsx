...
const UpperInfo = () => {
  return (
    ...
    <div className="flex flex-wrap bg-blue-200 font-black object-contain p-4 text-3xl text-nowrap">
      <div className="w-full xs:w-1/1 sm:w-1/1 md:w-1/2 lg:w-1/4 xl:w-1/5 p-4 text-center">
        瑞昱豐興業有限公司
      </div>
      <div className="w-full xs:w-1/1 sm:w-1/1 md:w-1/2 lg:w-1/4 xl:w-1/5 p-4 text-center">
        <div className="flex items-center justify-center">
          ...
          <div>
            <div className="text-2xl">服務範圍:</div>
            <div className="text-xl">台灣全省(離島除外)</div>
          </div>
        </div>
      </div>
      <div className="w-full xs:w-1/1 sm:w-1/1 md:w-1/2 lg:w-1/4 xl:w-1/5 p-4 text-center text-2xl">
        <div className="flex items-center justify-center">
