    ...
    return(
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 py-0 px-24">
          <div className="flex flex-col items-center ">
            <img src={`${__BASE_URL__}img/DisplayFunction001.img`} alt="First Pics"/>
            <div className="px-10">
              <p>
          ...
          <div>
            <img src={`${__BASE_URL__}img/DisplayFunction002.img`} alt="First Pics"/>
            <div className="px-10">
              <p>
          ...
          <div className="flex flex-col items-center">
            <img src={`${__BASE_URL__}img/DisplayFunction003.img`} alt="First Pics"/>
            <div className="px-10">
              <p>
