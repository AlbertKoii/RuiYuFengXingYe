...
const AirConditionalType : React.FC<AirConditionalTypeProps> = () =>{
    ...
    return(
        <div className="w-screen relative">
            <Carousel className="flex flex-wrap font-black object-contain p-4">
                <CarouselContent className="h-96 px-24 w-full xs:w-1/1 sm:w-1/1 md:w-1/2 lg:w-1/4 xl:w-1/5 p-4 text-center">
                    <CarouselItem className="basis-1/3 w-full xs:w-1/1 sm:w-1/1 md:w-1/2 lg:w-1/4 xl:w-1/5 p-4 text-center">
