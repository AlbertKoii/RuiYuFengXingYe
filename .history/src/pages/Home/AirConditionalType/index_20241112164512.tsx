...
const AirConditionalType : React.FC<AirConditionalTypeProps> = () =>{
    ...
    return(
        <div className="w-screen relative">
            <Carousel>
                <CarouselContent className="w-screen h-96 px-24 py-10 xs:basic-1/1 sm:basic-1 lg:basic-1/3 xl:basic-1/3">
                    ...
                    <CarouselItem className="basis-1/3 xs:basic-1/1 sm:basic-1 lg:basic-1/3 xl:basic-1/3">
                    <img src="https://www.maintenance-service.com.tw/images/home-2-223x227.jpg" alt="窗型冷氣保養"/>
                    窗型冷氣保養
                    </CarouselItem>
                    <CarouselItem className="basis-1/3 xs:basic-1 sm:basic-1 lg:basic-1/3 xl:basic-1/3">
