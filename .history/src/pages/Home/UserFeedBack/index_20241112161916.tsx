...
const UserFeedBack: React.FC<UserFeedBackProps> = () =>{
    ...
    return(
      ...
      <Carousel className='h-96 px-24 flex flex-wrap font-black object-contain p-4 xs:w-1/1 sm:w-1/1 md:w-1/2 lg:w-1/4 xl:w-1/5'>
        <CarouselContent className="ml-4">
          {Contents.map((Content)=>
            (
              <CarouselItem key={Content.id} className=" basis-1/3 pl-4 mt-20">
